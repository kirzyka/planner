...
export class TimeBlockController {
	...
	async updateOrder(@Body() updateOrderDto: UpdateOrderDto) {
		console.log('DTO', updateOrderDto);
	...
	@Put(':id')
	@Auth()
	async update(@Body() dto: TimeBlockDto, @CurrentUser('id') userId: string, @Param('id') timeBlockId: string) {
	...
	@Delete(':id')
	@Auth()
	async delete(@CurrentUser('id') userId: string, @Param('id') timeBlockId: string) {
